...
(
  ...
  ON uid.data = cuid.data
LEFT JOIN prefix_quiz_grades AS quizg
    ON attempts.userid = quizg.userid
    AND attempts.quiz = quizg.quiz
...
AND u.suspended = 0
AND (quizg.grade < 10 OR quizg.grade IS NULL)
AND uif.shortname = 'assessorgroup' 
AND 
    ((uid.data = 'Assessor Group 01' OR  uid.data = 'StartUp - Northland pilot') AND c.shortname != 'LAE-SS1LR-ELv1' AND (c.shortname != 'LAE-SS1-ELv1') AND c.category != 22 AND c.category != 90)
    OR
    (uid.data = 'Assessor Group 02' AND c.shortname != 'LAE-SS1LR-ELv1' AND c.shortname != 'LAE-SS1-ELv1')
    OR
    (uid.data = 'Assessor Group 03' AND c.shortname != 'LAE-SS1LR-ELv1' AND c.shortname != 'LAE-SS1-ELv1')
    OR
    (uid.data = 'Assessor Group 04' AND c.shortname != 'LAE-SS1LR-ELv1' AND c.shortname != 'LAE-SS1-ELv1')
    OR
    (uid.data = 'Assessor Group 05' AND c.shortname != 'LAE-SS1LR-ELv1' AND c.shortname != 'LAE-SS1-ELv1')
    OR
    (uid.data = 'Assessor Group 06' AND c.shortname != 'LAE-SS1LR-ELv1' AND c.shortname != 'LAE-SS1-ELv1')
    OR
    ((uid.data = 'Assessor Group 07' OR c.shortname = 'LAE-SS1LR-ELv1') AND c.shortname != 'LAE-SS1-ELv1')
    OR
    (uid.data = 'Assessor Group 08' AND c.shortname != 'LAE-SS1LR-ELv1' AND c.shortname != 'LAE-SS1-ELv1')
    OR
    (uid.data = 'Assessor Group 09' AND c.shortname != 'LAE-SS1LR-ELv1')
    OR
    (uid.data = 'Assessor Group 10' AND c.shortname != 'LAE-SS1LR-ELv1' AND c.shortname != 'LAE-SS1-ELv1')
    OR
    (uid.data = 'Assessor Group 11' AND c.shortname != 'LAE-SS1LR-ELv1' AND c.shortname != 'LAE-SS1-ELv1')
    OR
    (uid.data = 'Assessor Group 12' AND c.shortname != 'LAE-SS1LR-ELv1' AND c.shortname != 'LAE-SS1-ELv1')
    OR
    (uid.data = 'Assessor Group 13' AND c.shortname != 'LAE-SS1LR-ELv1' AND c.shortname != 'LAE-SS1-ELv1')
    OR
    (uid.data = 'Assessor Group 14' AND c.shortname != 'LAE-SS1LR-ELv1' AND c.shortname != 'LAE-SS1-ELv1')
    OR
    (uid.data = 'Assessor Group 15' AND c.shortname != 'LAE-SS1LR-ELv1' AND c.shortname != 'LAE-SS1-ELv1')
    OR
    (uid.data = 'Assessor Group 16' AND c.shortname != 'LAE-SS1LR-ELv1' AND c.shortname != 'LAE-SS1-ELv1')
    OR
    (uid.data = 'Assessor Group 17' AND c.shortname != 'LAE-SS1LR-ELv1' AND c.shortname != 'LAE-SS1-ELv1')
    OR
    (uid.data = 'Assessor Group 18' AND c.shortname != 'LAE-SS1LR-ELv1' AND c.shortname != 'LAE-SS1-ELv1')
    OR
    (uid.data = 'Assessor Group 19' AND c.shortname != 'LAE-SS1LR-ELv1' AND c.shortname != 'LAE-SS1-ELv1')
    OR
    (uid.data = 'Assessor Group 20')
